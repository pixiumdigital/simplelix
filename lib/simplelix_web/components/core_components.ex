defmodule SimplelixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SimplelixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SimplelixWeb.Gettext, "errors", msg, opts)
    end
  end
